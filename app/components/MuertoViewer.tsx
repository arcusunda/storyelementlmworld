...
export default function MuertoViewer() {
    ...
    <div>
      <div className="mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-sm text-gray-400">
          Found {nfts.length} Muerto{nfts.length !== 1 ? 's. ' : '. '} Create a backstory or chat with your Muerto.
        </div>
          ...
          >
            {nft.image ? (
              <div className="relative w-full pt-[100%]">
                <Link href={`/losmuertosworld/character?tokenId=${nft.tokenId}`}>
                  <Image
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-bold text-xl">{nft.name || `Los Muertos #${nft.tokenId}`}</h3>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                <Link
                  href={`/losmuertosworld/character?tokenId=${nft.tokenId}`}
