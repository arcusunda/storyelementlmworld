...
interface BackstoryShareButtonProps {
  muertosId: number;
...
const BackstoryShareButton: React.FC<BackstoryShareButtonProps> = ({
  muertosId,
  characterName,
  backstory,
  className = '',
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/anthropic/generate-tweet', {
        characterName,
        backstory,
      ...
      const url = `${window.location.origin}/losmuertosworld/backstories/s/${shortId}`;
...
export default BackstoryShareButton;